...
exports.show_alert = exports.hide_alert = void 0;
...
var show_alert = function show_alert(type, msg) {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.show_alert)("success", "Login successfully");
...
exports.display_map = display_map;
...
var update_setting = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "password" ? "update-password" : "update-my-account";
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.show_alert)("success", "".concat(type.toUpperCase(), " Update successfully"));
            }
  ...
  return function update_setting(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var stripe = Stripe("pk_test_51KcnSiKNT9DxG2cpUIVGnE3BQA5TBqCySBfvl5c81GlvfJ6DHVG8Uj7NS2qcKoTP6a2D4KBR6tAJKTvSW9q2T6gH00CAdkpacY");

var book_tour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tour_id) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tour_id));
  ...
  return function book_tour(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.book_tour = book_tour;
...
var login_from = document.querySelector(".form--login");
...
if (form_user_data) {
  form_user_data.addEventListener("submit", function (e) {
    ...
    (0, _updateSettings.update_setting)(form, "data");
  });
}

if (form_user_password) {
  form_user_password.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var btn_save_password, oldPassword, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              btn_save_password = document.querySelector(".btn--save-password");
              oldPassword = document.getElementById("password-current").value;
              password = document.getElementById("password").value;
              passwordConfirm = document.getElementById("password-confirm").value;
              btn_save_password.textContent = "Updating ...";
              _context.next = 8;
              return (0, _updateSettings.update_setting)({
...
if (book_btn) {
  book_btn.addEventListener("click", function (e) {
    ...
    var tour_id = e.target.dataset.tour_id;
    (0, _stripe.book_tour)(tour_id);
  });
}

var alert_message = document.querySelector("body").dataset.alert;
if (alert_message) (0, _alert.show_alert)("success", alert_message, 20);
